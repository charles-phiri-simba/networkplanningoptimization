...
@Entity
@Table(name = "network_change_execution_operation")
public class NetworkChangeExecutionOperationEntity {
    ...
    public static NetworkChangeExecutionOperationEntity create(
            UUID id,
            UUID executionId,
            int sequenceNumber,
        ...
        NetworkChangeExecutionOperationEntity entity = new NetworkChangeExecutionOperationEntity();
        entity.id = id;
