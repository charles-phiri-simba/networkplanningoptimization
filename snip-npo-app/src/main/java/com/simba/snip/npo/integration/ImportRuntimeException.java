    ...
    public static boolean retryableDefault(ImportFailureCode code) {
        return switch (code) {
            case SCHEMA_UNSUPPORTED, VALIDATION_FATAL, SNAPSHOT_ID_CONTENT_MISMATCH,
                    ...
                    CONNECTOR_CANCELLED, PRODUCTION_TRANSPORT_NOT_CONFIGURED, SYNCHRONIZATION_DISABLED,
                    INCREMENTAL_NOT_SUPPORTED, CHECKPOINT_REJECTED, CHECKPOINT_EXPIRED, SEQUENCE_GAP,
                    RECOVERY_REQUIRED, CHECKPOINT_UNCERTAIN -> false;
