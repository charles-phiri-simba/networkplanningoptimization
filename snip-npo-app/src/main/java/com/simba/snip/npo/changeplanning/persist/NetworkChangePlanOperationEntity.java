...
@Entity
@Table(name = "network_change_plan_operation")
public class NetworkChangePlanOperationEntity {
    ...
    public static NetworkChangePlanOperationEntity create(
            UUID id,
            UUID planId,
            int sequenceNumber,
        ...
        NetworkChangePlanOperationEntity entity = new NetworkChangePlanOperationEntity();
        entity.id = id;
